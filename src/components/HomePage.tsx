    ...
    return ( <Layout>
        <div className="flex bg-white place-content-around  min-w-full items-center p-4">
            ...
            <div className="flex h-6 space-x-4 " >
                ...
                <button onClick={()=>{setModal('modal1'), handleOpen()}}><AddBoxOutlinedIcon/></button>
        ...
        <div className="relative "><CreateModal open={open} handleClose={handleClose} setModal={setModal} modal={modal} refetchData={refetchData}/></div>
