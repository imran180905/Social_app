...
export default function Comments({
  ...
  useEffect(() => {
    const filteredComments = comment?.filter(
      (comment: singleDataTypes) => comment?.postId === selectedPostId
    );
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      setSubmittedComments((prevComments: any) => [
        ...prevComments,
        singleComment,
      ]);
          ...
          <div className={Styles.box}>
            ...
            <Box>
              <Typography
                ...
                component="div"
                className={Styles.modalDetailsSection}
              >
                <div>
                ...
                <div
                  className={`${Styles.scrollableContainer} ${Styles.commentsContainer}`}
                >
                  <div>
